...
function Pm2_5LabelComponent({device, objectPM2_5FromWs}) {
        ...
        <>
            ...
            <div className="flex justify-evenly w-full mt-5 gap-5 flex-col">
                <div className="flex justify-evenly w-full relative">
                    ...
                    <Typography
                        variant="h6">{(objectPM2_5FromWs.deviceId == device.id && isOnline) ? `${objectPM2_5FromWs.value}µg/m³` : "__"}</Typography>
                </div>
            </div>
        </>
    )
...
export default Pm2_5LabelComponent;
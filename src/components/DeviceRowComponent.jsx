...
function DeviceRowComponent({device}) {
    ...
    if (device) {
        ...
        var handleView = () => {
            if (isManager) navigate(`/dash/devices/${device.id}/view`);
            else if (isAdmin) navigate(`/admin/devices/${device.id}/view`);
        }
                                ...
                                primary={
                                    (
                                        <Link
                                            ...
                                            to={(isManager) ? `/dash/devices/${device.id}/view` : (isAdmin) ? `/admin/devices/${device.id}/view` : ``}
                                        >
                                            {device?.name}
                                        </Link>
                                    ) || "N/A"
